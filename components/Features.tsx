  ...
  return (
    <section className="bg-white dark:bg-gray-900 sm:container relative">
      <div className="flex lg:flex-row items-center flex-col-reverse sm:mb-[-100px] sm:px-10 px-5">
        ...
        >
          <Image src={FeaturesImage} height={1000} width={1000} alt="Features" />
        </motion.div>
        <div>
          <div className="mb-8">
            <motion.h3
            ...
            <motion.h1
              ...
              className="sm:text-5xl text-3xl font-clash-display font-bold mb-4"
            >
              Uifry Premium
            </motion.h1>
          </div>
      ...
      <Image
        ...
        loading="lazy"
      />
      <Image src={Star} alt="Star" height={50} width={50} className="absolute bottom-0 top-20 hidden md:block" />
    </section>
  );
};
